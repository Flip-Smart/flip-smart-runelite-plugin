...
public class ExitPriceResolverTest
{
	...
	public void breakevenPrefersBackendPrice()
	{
		...
		long p = ExitPriceResolver.resolve(ExitTradesMode.BREAKEVEN, 4151, 1000, 3958998, new WikiPrice(1100, 950));
	...
	public void breakevenUsesGeTaxWhenBackendMissing()
	{
		...
		long p = ExitPriceResolver.resolve(ExitTradesMode.BREAKEVEN, 4151, 1000, 0, new WikiPrice(1100, 950));
		assertEquals(1020, p);
	}
	...
	{
		long p = ExitPriceResolver.resolve(ExitTradesMode.INSTANT, 4151, 1000, 0, new WikiPrice(1100, 950));
		assertEquals(950, p);
	}
	...
	public void breakevenFallsBackToMidWhenBackendAndBasisMissing()
	{
		...
		long p = ExitPriceResolver.resolve(ExitTradesMode.BREAKEVEN, 4151, 0, 0, new WikiPrice(1100, 950));
		assertEquals(1025, p);
	}
	...
	{
		long p = ExitPriceResolver.resolve(ExitTradesMode.INSTANT, 4151, 0, 0, new WikiPrice(1100, 0));
