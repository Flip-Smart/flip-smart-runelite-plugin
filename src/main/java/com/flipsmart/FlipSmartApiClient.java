...
import com.flipsmart.api.endpoints.PendingTradesEndpoints;
...
public class FlipSmartApiClient
{
	...
	private final PendingTradesEndpoints pendingTrades;
	...
	public FlipSmartApiClient(FlipSmartConfig config, Gson gson, OkHttpClient okHttpClient)
	{
		...
		this.pendingTrades = new PendingTradesEndpoints(transport);
	}
	...
	{
		return pendingTrades.reportPendingTradeOfferAsync(rsn, slot, itemId, isBuy, price, quantity, quantityFilled, state);
	}
